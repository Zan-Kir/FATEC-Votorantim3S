...
public class connectDAO {
    ...
    public Usuario pesquisaUsuarioJFBD(String tabela, String pesquisaId) {
       ...
       public Empresa pesquisaEmpresaJFBD(String tabela, String pesquisaId) {
        Empresa empresaReturn = new Empresa();
        String tabelaSGBD = "Empresa";
        if (tabela.equals(tabelaSGBD)) {
            ...
            try {
                ...
                try {
                    ...
                    if (dados.next() == false) {
                        ...
                        empresaReturn.setIdEmpresa(dados.getInt(1));
                        empresaReturn.setNomeEmpresa(dados.getString(2));
                        empresaReturn.setTelefoneEmpresa(dados.getString(3));
                        empresaReturn.setEmailEmpresa(dados.getString(4));
                        empresaReturn.setSiteEmpresa(dados.getString(5));
                        empresaReturn.setTipoEmpresa(dados.getString(6));
                        empresaReturn.setCNPJ(dados.getString(7));
                        empresaReturn.setUserImg(dados.getString(8));
                        empresaReturn.setServico(dados.getString(9));
                        empresaReturn.setCidade(dados.getString(10));
                        empresaReturn.setUF(dados.getString(11));
                        empresaReturn.setCEP(dados.getString(12));
                        empresaReturn.setLogradouro(dados.getString(13));
                        empresaReturn.setNumero(dados.getString(14));
                        empresaReturn.setComplemento(dados.getString(15));
                        empresaReturn.setBairro(dados.getString(16));
                    }
                    con.close();
